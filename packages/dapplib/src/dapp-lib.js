...
module.exports = class DappLib {
	...
	static async receiveStoneTenant(data) {
		let result = await Blockchain.post(
			{
				config: DappLib.getConfig(),
				roles: {
	...
	static async receiveWoodTenant(data) {
		let result = await Blockchain.post(
			{
				config: DappLib.getConfig(),
				roles: {
	...
	static async receiveBridge(data) {
		let result = await Blockchain.post(
			{
				config: DappLib.getConfig(),
				roles: {
	...
	static async hasStoneTenant(data) {
		let result = await Blockchain.get(
			{
				config: DappLib.getConfig(),
				roles: {},
			},
			'registry_has_stone_tenant',
			{
				tenant: {
					value: data.tenant,
					type: t.Address,
		...
		return {
			type: DappLib.DAPP_RESULT_BOOLEAN,
			label: 'Has Stone Tenant',
			result: result.callData,
		};
	}

	static async hasWoodTenant(data) {
		let result = await Blockchain.get(
			{
				config: DappLib.getConfig(),
				roles: {},
			},
			'registry_has_wood_tenant',
			{
				tenant: {
					value: data.tenant,
					type: t.Address,
		...
		return {
			type: DappLib.DAPP_RESULT_BOOLEAN,
			label: 'Has Wood Tenant',
			result: result.callData,
		};
	}

	static async hasBridge(data) {
		let result = await Blockchain.get(
			{
				config: DappLib.getConfig(),
				roles: {},
